package com.jia.ocr.util.support;
...
public class HttpApiClient {
	...
	public static String recognize(String soft_id, String soft_key,
		...
		params.put("log", String.valueOf("1"));
	 ...
	 */
	public static void reportError(final String pic_id) {
		...
		new Thread(){
			public void run() {
				...
				String s=HttpClientUtil.sendPostRequest(RequestUrl.HTTP_API_URL.getUrl(),
						params, "UTF-8", "UTF-8");
//				System.out.println("异常反馈结果:"+s);
			};
		}.start();
